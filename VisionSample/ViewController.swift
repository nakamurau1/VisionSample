...
//  VisionSample
//
//  Created by yuichi.nakamura on 2017/11/27.
//  Copyright © 2017年 yuichi.nakamura. All rights reserved.
//
...
extension ViewController: AVCaptureVideoDataOutputSampleBufferDelegate {
    ...
    func captureOutput(_ output: AVCaptureOutput, didOutput sampleBuffer: CMSampleBuffer, from connection: AVCaptureConnection) {
        ...
        let request = getFaceRectangleRequest()
        
        try! handler.perform([request])
    }
    
    private func getTextRectanglesRequest() -> VNDetectTextRectanglesRequest {
    ...
    private func getFaceRectangleRequest() -> VNDetectFaceRectanglesRequest {
    ...
    private func sampleBufferToUIImage(sampleBuffer: CMSampleBuffer, with orientation: UIInterfaceOrientation) -> UIImage {
